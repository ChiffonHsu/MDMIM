...
object #32011 x 70 data frame (variable_info)
#2. generate interactive plot
load("~/MDMIM/2_data/preliminary_determination_bacterial_metabolomics/20251025/MS1/Result/intermediate_data/xdata2")
