...
dir.create("2_data/preliminary_determination_bacterial_metabolomics/MS1/POS/data_cleaning/", showWarnings = FALSE, recursive = TRUE)
save(object_pos, file = "2_data/preliminary_determination_bacterial_metabolomics/MS1/POS/data_cleaning/object_pos")
object_pos
dim(object_pos)
object_pos %>% 
  activate_mass_dataset(what = "sample_info") %>% 
...
#4. Explore missing values (mvs):
  get_mv_number(object = object_pos)  #219072
